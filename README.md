...
By default, PIVOT considers "CHM13" as the reference. In case another haplotype is to be used as the reference (or the name is different in the graph), the **-ref** parameter in rule **find_anchors** needs to be adjusted. The haplotype numebr this reference haplotype has in the graph is to be specified via **-ref_hap** parameter.
